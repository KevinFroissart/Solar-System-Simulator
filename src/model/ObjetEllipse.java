...
public class ObjetEllipse extends Objet {

	private int idx;
	private List<Image> Album;
	
	public ObjetEllipse(String name, String type, double masse, Vecteur pos, double attraction, double periode, Objet f1, Objet f2) {
		super(name, type, masse, pos, new Vecteur(0, 0), 0, attraction, periode, f1, f2);
